// ======================================================================
// Controlador.v generated from TopDesign.cysch
// 10/30/2019 at 19:20
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("140d93bc-5dbb-4f89-990e-95f3caef3042/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__EncoderA_net;
	wire [0:0] tmpIO_0__EncoderA_net;
	wire [0:0] tmpINTERRUPT_0__EncoderA_net;
	electrical [0:0] tmpSIOVREF__EncoderA_net;
	...
	cy_psoc3_pins_v1_10
		...
		EncoderA
		 (.oe(tmpOE__EncoderA_net),
		  .y({1'b0}),
		  .fb({Net_1}),
		  .io({tmpIO_0__EncoderA_net[0:0]}),
		  .siovref(tmpSIOVREF__EncoderA_net),
		  .interrupt({tmpINTERRUPT_0__EncoderA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EncoderA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EncoderB_net;
	wire [0:0] tmpIO_0__EncoderB_net;
	wire [0:0] tmpINTERRUPT_0__EncoderB_net;
	electrical [0:0] tmpSIOVREF__EncoderB_net;

	cy_psoc3_pins_v1_10
		#(.id("c25d7383-f12f-44da-a592-742e9954b604"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		EncoderB
		 (.oe(tmpOE__EncoderB_net),
		  .y({1'b0}),
		  .fb({Net_2}),
		  .io({tmpIO_0__EncoderB_net[0:0]}),
		  .siovref(tmpSIOVREF__EncoderB_net),
		  .interrupt({tmpINTERRUPT_0__EncoderB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EncoderB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("881fe9da-168e-4284-8a42-88b5a3419a5b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("83333333.3333333"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e59c1caf-8b62-416c-ab77-0b4b799f7442"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
